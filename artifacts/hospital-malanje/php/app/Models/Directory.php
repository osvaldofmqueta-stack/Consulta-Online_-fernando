<?php
/** CRUD do directório de departamentos e médicos do hospital. */
declare(strict_types=1);

final class HospitalDirectory
{
    /** Lista departamentos, colocando os activos primeiro. */
    public static function departments(): array
    {
        return Database::connection()->query('SELECT * FROM departamentos ORDER BY active DESC, name')->fetchAll();
    }

    /** Lista médicos com o nome do departamento associado. */
    ...
    /** Cria um departamento activo com uma cor de identificação. */
    ...
    /** Actualiza o nome e o estado de um departamento sem apagar histórico. */
    ...
    /** Cria um médico e calcula iniciais para a apresentação visual. */
    ...
    /** Actualiza dados e estado do médico mantendo o registo referenciado. */
